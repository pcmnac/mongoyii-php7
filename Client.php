...
class Client extends CApplicationComponent
{
	...
	public function init()
	{
		...
		CValidator::$builtInValidators['subdocument'] = 'pcmnac\mongoyii\validators\SubdocumentValidator';
		parent::init();
	}

	/**
	 * init Mongodb Connect
	 * @throws \pcmnac\mongoyii\Exception
	 */
	 ...
	 * @param null $name
	 * @param array $options
	 * @return null|\pcmnac\mongoyii\Database
	 * @throws \pcmnac\mongoyii\Exception
	 */
